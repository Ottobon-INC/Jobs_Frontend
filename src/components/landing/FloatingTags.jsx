...
const variantClasses = {
    filled:
        "bg-[#D45B34] text-white shadow-[0_12px_32px_-24px_rgba(212,91,52,0.4)]",
    outlined:
        "bg-[#F4F1EA]/80 border border-[#D45B34]/30 text-[#1C1A17]/85 shadow-[0_12px_32px_-26px_rgba(28,26,23,0.15)] backdrop-blur-sm",
};
