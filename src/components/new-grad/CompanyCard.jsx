    ...
    return (
        ...
        >
            <div className="flex items-start justify-between mb-8">
                <div className="p-4 bg-[var(--color-background-soft)] rounded-3xl border border-[var(--color-primary)]/5 group-hover:scale-110 transition-all duration-500 shadow-sm">
                    <CompanyLogo company={company} className="w-12 h-12 bg-transparent" />
                </div>
            ...
            <h3 className="text-3xl font-black text-[var(--color-primary)] mb-1 tracking-tight">{company.name}</h3>
            <p className="text-[10px] font-black text-[var(--color-primary)]/30 uppercase tracking-[0.2em] mb-8">{company.category}</p>

            <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="p-4 bg-[var(--color-primary)]/5 rounded-[2rem] border border-[var(--color-primary)]/5 flex flex-col justify-center">
                    <p className="text-[8px] font-black text-[var(--color-primary)]/30 uppercase tracking-widest mb-2">Total Year 1</p>
                ...
                <div className="p-4 bg-[var(--color-primary)]/5 rounded-[2rem] border border-[var(--color-primary)]/5 flex flex-col justify-center">
                    <p className="text-[8px] font-black text-[var(--color-primary)]/30 uppercase tracking-widest mb-2">Interview</p>
                    <div className="flex items-center gap-1.5 text-[var(--color-primary)] font-black text-sm">
