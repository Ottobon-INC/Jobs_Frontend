...
const Sidebar = () => {
    ...
    const links = [
        ...
        { to: '/mock-interview', label: 'Interview Prep', icon: Headset, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/materials', label: 'Interview Materials', icon: FileText, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/interview-reviews', label: 'Interview Reviews', icon: ClipboardText, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/my-human-mock-interviews', label: '1-on-1 Sessions', icon: Users, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/chat', label: 'Messages', icon: ChatText, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/rewards', label: 'Rewards', icon: Trophy, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        { to: '/engagement/hub', label: 'Arcade Hub', icon: GameController, roles: [ROLES.SEEKER], category: 'RESOURCES' },
        ...
        { to: '/market-intelligence', label: 'Market Analytics', icon: TrendUp, roles: [ROLES.PROVIDER, ROLES.SEEKER], category: 'ANALYTICS' },
        { to: '/blogs', label: 'Career Blog', icon: Newspaper, roles: [ROLES.SEEKER, ROLES.PROVIDER, ROLES.ADMIN], category: 'ANALYTICS' },
        { to: '/admin/dashboard', label: 'Admin Dashboard', icon: SquaresFour, roles: [ROLES.ADMIN], category: 'Administrative' },
        { to: '/admin/knowledge', label: 'Brain', icon: Brain, roles: [ROLES.ADMIN], category: 'Administrative' },
        { to: '/admin/tower', label: 'Control Tower', icon: Radio, roles: [ROLES.ADMIN], category: 'Administrative' },
        { to: '/admin/interview-reviews', label: 'Interview Reviews', icon: ClipboardText, roles: [ROLES.ADMIN], category: 'Administrative' },
        { to: '/admin/feedback', label: 'User Feedback', icon: ChartBar, roles: [ROLES.ADMIN], category: 'Administrative' },
        ...
        { to: '/admin/courses', label: 'Manage Courses', icon: BookOpen, roles: [ROLES.ADMIN], category: 'Administrative' },
        { to: '/admin/add-data', label: 'Add Materials', icon: PlusCircle, roles: [ROLES.ADMIN], category: 'Administrative' },
