  ...
  return (
    <main className="bg-white">
      ...
      <div className="relative flex h-dvh w-full flex-col items-center overflow-hidden">
        ...
        <div className="pointer-events-none absolute z-10 mt-24 space-y-6 text-center">
          ...
          <p className="text-sm text-black/60 drop-shadow-md">
            We help you find the perfect job that matches your skills and interests.
          </p>
          <button
            onClick={scrollToJobs}
            className="animated-button pointer-events-auto mt-4 mx-auto cursor-pointer"
          >
